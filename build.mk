...
build-x86_64/datetime: build-x86_64/user/datetime.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	datetime)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/datetime build-x86_64/user/datetime.o 
build-x86_64/user/datetime.o: user/datetime.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	datetime.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/datetime.d -c user/datetime.c -o build-x86_64/user/datetime.o
...
sysroot/bin/datetime: build-x86_64/datetime
	$(call MP_INFO,install	datetime)
	@cp build-x86_64/datetime sysroot/bin/datetime
