...
build-x86_64/libc/serial.o: libc/serial.c
	@mkdir -p build-x86_64/libc
	@mkdir -p dep/libc
	$(call MP_INFO,CC	serial.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libc/serial.d -c libc/serial.c -o build-x86_64/libc/serial.o
...
build-x86_64/libsocs.a:  sysroot/usr/lib/libc.a
	$(call MP_INFO,AR	libsocs.a)
	@ar rcs -o build-x86_64/libsocs.a 

build-x86_64/libm.a: build-x86_64/libm/math.o 
	$(call MP_INFO,AR	libm.a)
	@ar rcs -o build-x86_64/libm.a build-x86_64/libm/math.o
build-x86_64/libm/math.o: libm/math.c
	@mkdir -p build-x86_64/libm
	@mkdir -p dep/libm
	$(call MP_INFO,CC	math.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -fno-builtin -MD -MF dep/libm/math.d -c libm/math.c -o build-x86_64/libm/math.o
...
build-x86_64/libc.so: build-x86_64/libc_so/crt0.o build-x86_64/libc_so/crti.o build-x86_64/libc_so/crtn.o build-x86_64/libc_so/ctype.o build-x86_64/libc_so/entry.o build-x86_64/libc_so/errno.o build-x86_64/libc_so/fstdio.o build-x86_64/libc_so/fstdio_unlocked.o build-x86_64/libc_so/getopt.o build-x86_64/libc_so/locale.o build-x86_64/libc_so/malloc.o build-x86_64/libc_so/serial.o build-x86_64/libc_so/setjmp.o build-x86_64/libc_so/signal.o build-x86_64/libc_so/stdio.o build-x86_64/libc_so/stdlib.o build-x86_64/libc_so/string.o build-x86_64/libc_so/strtod.o build-x86_64/libc_so/synnixos.o build-x86_64/libc_so/syscall.o build-x86_64/libc_so/syscalls.o build-x86_64/libc_so/time.o build-x86_64/libc_so/todo.o build-x86_64/libc_so/unistd.o build-x86_64/libc_so/vector.o build-x86_64/libc_so/x86_64/synnixos.o 
	$(call MP_INFO,LD	libc.so)
	@~/.local/bin/x86_64-synnixos-gcc -nostdlib -fpic -shared -g -o build-x86_64/libc.so build-x86_64/libc_so/crt0.o build-x86_64/libc_so/crti.o build-x86_64/libc_so/crtn.o build-x86_64/libc_so/ctype.o build-x86_64/libc_so/entry.o build-x86_64/libc_so/errno.o build-x86_64/libc_so/fstdio.o build-x86_64/libc_so/fstdio_unlocked.o build-x86_64/libc_so/getopt.o build-x86_64/libc_so/locale.o build-x86_64/libc_so/malloc.o build-x86_64/libc_so/serial.o build-x86_64/libc_so/setjmp.o build-x86_64/libc_so/signal.o build-x86_64/libc_so/stdio.o build-x86_64/libc_so/stdlib.o build-x86_64/libc_so/string.o build-x86_64/libc_so/strtod.o build-x86_64/libc_so/synnixos.o build-x86_64/libc_so/syscall.o build-x86_64/libc_so/syscalls.o build-x86_64/libc_so/time.o build-x86_64/libc_so/todo.o build-x86_64/libc_so/unistd.o build-x86_64/libc_so/vector.o build-x86_64/libc_so/x86_64/synnixos.o 
...
build-x86_64/libc_so/serial.o: libc/serial.c
	@mkdir -p build-x86_64/libc_so
	@mkdir -p dep/libc_so
	$(call MP_INFO,CC	serial.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -fpic -shared -MD -MF dep/libc_so/serial.d -c libc/serial.c -o build-x86_64/libc_so/serial.o
...
build-x86_64/modules/syscall.o: modules/syscall.c
	...
	@mkdir -p dep/modules
	$(call MP_INFO,CC	syscall.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -pedantic -ffreestanding -mno-red-zone -mno-80387 -mno-mmx -mno-sse -mno-sse2 -nostdlib -fno-asynchronous-unwind-tables -fno-omit-frame-pointer -DSYNNIXOS_VERSION=\"$(SYNNIXOS_VERSION)\" -D__kernel__=1 -D_SNX=1 -mcmodel=kernel -fsanitize=undefined $(KERNEL_CFLAGS) -MD -MF dep/modules/syscall.d -c modules/syscall.c -o build-x86_64/modules/syscall.o
...
build-x86_64/tagha: build-x86_64/user/tagha.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	tagha)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/tagha build-x86_64/user/tagha.o 
build-x86_64/user/tagha.o: user/tagha.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	tagha.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/tagha.d -c user/tagha.c -o build-x86_64/user/tagha.o
build-x86_64/brainfuck: build-x86_64/user/brainfuck.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	brainfuck)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/brainfuck build-x86_64/user/brainfuck.o 
build-x86_64/user/brainfuck.o: user/brainfuck.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	brainfuck.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/brainfuck.d -c user/brainfuck.c -o build-x86_64/user/brainfuck.o
...
build-x86_64/cd: build-x86_64/user/cd.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	cd)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/cd build-x86_64/user/cd.o 
build-x86_64/user/cd.o: user/cd.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	cd.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/cd.d -c user/cd.c -o build-x86_64/user/cd.o
...
build-x86_64/shutdown: build-x86_64/user/shutdown.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	shutdown)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/shutdown build-x86_64/user/shutdown.o 
build-x86_64/user/shutdown.o: user/shutdown.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	shutdown.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/shutdown.d -c user/shutdown.c -o build-x86_64/user/shutdown.o
build-x86_64/testmath: build-x86_64/user/testmath.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	testmath)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/testmath build-x86_64/user/testmath.o 
build-x86_64/user/testmath.o: user/testmath.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	testmath.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/testmath.d -c user/testmath.c -o build-x86_64/user/testmath.o
build-x86_64/modprobe: build-x86_64/user/modprobe.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	modprobe)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/modprobe build-x86_64/user/modprobe.o 
build-x86_64/user/modprobe.o: user/modprobe.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	modprobe.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/modprobe.d -c user/modprobe.c -o build-x86_64/user/modprobe.o
...
build-x86_64/clear: build-x86_64/user/clear.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	clear)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/clear build-x86_64/user/clear.o 
build-x86_64/user/clear.o: user/clear.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	clear.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/clear.d -c user/clear.c -o build-x86_64/user/clear.o
...
build-x86_64/testserial: build-x86_64/user/testserial.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	testserial)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/testserial build-x86_64/user/testserial.o 
build-x86_64/user/testserial.o: user/testserial.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	testserial.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/testserial.d -c user/testserial.c -o build-x86_64/user/testserial.o
...
build-x86_64/date: build-x86_64/user/date.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	date)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/date build-x86_64/user/date.o 
build-x86_64/user/date.o: user/date.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	date.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/date.d -c user/date.c -o build-x86_64/user/date.o
...
build-x86_64/whoami: build-x86_64/user/whoami.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	whoami)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/whoami build-x86_64/user/whoami.o 
build-x86_64/user/whoami.o: user/whoami.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	whoami.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/whoami.d -c user/whoami.c -o build-x86_64/user/whoami.o
...
build-x86_64/getenv: build-x86_64/user/getenv.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	getenv)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/getenv build-x86_64/user/getenv.o 
build-x86_64/user/getenv.o: user/getenv.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	getenv.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/getenv.d -c user/getenv.c -o build-x86_64/user/getenv.o
build-x86_64/pwd: build-x86_64/user/pwd.o sysroot/usr/lib/libc.so sysroot/usr/lib/libc.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a
	$(call MP_INFO,LD	pwd)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/pwd build-x86_64/user/pwd.o 
build-x86_64/user/pwd.o: user/pwd.c
	@mkdir -p build-x86_64/user
	@mkdir -p dep/user
	$(call MP_INFO,CC	pwd.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/user/pwd.d -c user/pwd.c -o build-x86_64/user/pwd.o
...
sysroot/usr/lib/libsocs.a: build-x86_64/libsocs.a
	$(call MP_INFO,install	libsocs.a)
	@cp build-x86_64/libsocs.a sysroot/usr/lib/libsocs.a
...
sysroot/bin/tagha: build-x86_64/tagha
	$(call MP_INFO,install	tagha)
	@cp build-x86_64/tagha sysroot/bin/tagha

sysroot/bin/brainfuck: build-x86_64/brainfuck
	$(call MP_INFO,install	brainfuck)
	@cp build-x86_64/brainfuck sysroot/bin/brainfuck
...
sysroot/bin/cd: build-x86_64/cd
	$(call MP_INFO,install	cd)
	@cp build-x86_64/cd sysroot/bin/cd
...
sysroot/bin/shutdown: build-x86_64/shutdown
	$(call MP_INFO,install	shutdown)
	@cp build-x86_64/shutdown sysroot/bin/shutdown

sysroot/bin/testmath: build-x86_64/testmath
	$(call MP_INFO,install	testmath)
	@cp build-x86_64/testmath sysroot/bin/testmath

sysroot/bin/modprobe: build-x86_64/modprobe
	$(call MP_INFO,install	modprobe)
	@cp build-x86_64/modprobe sysroot/bin/modprobe

sysroot/bin/mmap: build-x86_64/mmap
	$(call MP_INFO,install	mmap)
	@cp build-x86_64/mmap sysroot/bin/mmap

sysroot/bin/clear: build-x86_64/clear
	$(call MP_INFO,install	clear)
	@cp build-x86_64/clear sysroot/bin/clear
...
sysroot/bin/testserial: build-x86_64/testserial
	$(call MP_INFO,install	testserial)
	@cp build-x86_64/testserial sysroot/bin/testserial
...
sysroot/bin/date: build-x86_64/date
	$(call MP_INFO,install	date)
	@cp build-x86_64/date sysroot/bin/date

sysroot/bin/echo: build-x86_64/echo
	$(call MP_INFO,install	echo)
	@cp build-x86_64/echo sysroot/bin/echo

sysroot/bin/whoami: build-x86_64/whoami
	$(call MP_INFO,install	whoami)
	@cp build-x86_64/whoami sysroot/bin/whoami
...
sysroot/bin/getenv: build-x86_64/getenv
	$(call MP_INFO,install	getenv)
	@cp build-x86_64/getenv sysroot/bin/getenv

sysroot/bin/pwd: build-x86_64/pwd
	$(call MP_INFO,install	pwd)
	@cp build-x86_64/pwd sysroot/bin/pwd
...
MP_ALL_INSTALL_TARGETS := sysroot/usr/lib/libc.a sysroot/usr/lib/libsocs.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a sysroot/usr/lib/libc.so snxk.elf sysroot/usr/lib/crt0.o sysroot/bin/sh sysroot/bin/ld-snx.so sysroot/bin/syscall.ko sysroot/bin/procmod.ko sysroot/bin/tagha sysroot/bin/brainfuck sysroot/bin/ls sysroot/bin/column sysroot/bin/trace sysroot/bin/modsys sysroot/bin/cd sysroot/bin/step sysroot/bin/false sysroot/bin/shutdown sysroot/bin/testmath sysroot/bin/modprobe sysroot/bin/mmap sysroot/bin/clear sysroot/bin/rm sysroot/bin/cat sysroot/bin/init sysroot/bin/testserial sysroot/bin/kill sysroot/bin/chmod sysroot/bin/time sysroot/bin/strace sysroot/bin/sleep sysroot/bin/date sysroot/bin/echo sysroot/bin/whoami sysroot/bin/top sysroot/bin/rot13 sysroot/bin/xd sysroot/bin/create sysroot/bin/args sysroot/bin/uname sysroot/bin/true sysroot/bin/getenv sysroot/bin/pwd sysroot/bin/traceback
MP_ALL_INSTALL := sysroot/usr/lib/libc.a sysroot/usr/lib/libsocs.a sysroot/usr/lib/libm.a sysroot/usr/lib/libelf.a sysroot/usr/lib/libc.so build-x86_64/libk.a snxk.elf sysroot/usr/lib/crt0.o sysroot/bin/sh sysroot/bin/ld-snx.so sysroot/bin/syscall.ko sysroot/bin/procmod.ko sysroot/bin/tagha sysroot/bin/brainfuck sysroot/bin/ls sysroot/bin/column sysroot/bin/trace sysroot/bin/modsys sysroot/bin/cd sysroot/bin/step sysroot/bin/false sysroot/bin/shutdown sysroot/bin/testmath sysroot/bin/modprobe sysroot/bin/mmap sysroot/bin/clear sysroot/bin/rm sysroot/bin/cat sysroot/bin/init sysroot/bin/testserial sysroot/bin/kill sysroot/bin/chmod sysroot/bin/time sysroot/bin/strace sysroot/bin/sleep sysroot/bin/date sysroot/bin/echo sysroot/bin/whoami sysroot/bin/top sysroot/bin/rot13 sysroot/bin/xd sysroot/bin/create sysroot/bin/args sysroot/bin/uname sysroot/bin/true sysroot/bin/getenv sysroot/bin/pwd sysroot/bin/traceback
MP_ALL_TARGETS := build-x86_64/libc.a build-x86_64/libsocs.a build-x86_64/libm.a build-x86_64/libelf.a build-x86_64/libc.so build-x86_64/libk.a build-x86_64/snxk.elf build-x86_64/crt0.o build-x86_64/sh build-x86_64/ld-snx.so build-x86_64/syscall.ko build-x86_64/procmod.ko build-x86_64/tagha build-x86_64/brainfuck build-x86_64/ls build-x86_64/column build-x86_64/trace build-x86_64/modsys build-x86_64/cd build-x86_64/step build-x86_64/false build-x86_64/shutdown build-x86_64/testmath build-x86_64/modprobe build-x86_64/mmap build-x86_64/clear build-x86_64/rm build-x86_64/cat build-x86_64/init build-x86_64/testserial build-x86_64/kill build-x86_64/chmod build-x86_64/time build-x86_64/strace build-x86_64/sleep build-x86_64/date build-x86_64/echo build-x86_64/whoami build-x86_64/top build-x86_64/rot13 build-x86_64/xd build-x86_64/create build-x86_64/args build-x86_64/uname build-x86_64/true build-x86_64/getenv build-x86_64/pwd build-x86_64/traceback
MP_ALL_OBJECTS := build-x86_64/libc.a build-x86_64/libc/crt0.o build-x86_64/libc/crti.o build-x86_64/libc/crtn.o build-x86_64/libc/ctype.o build-x86_64/libc/entry.o build-x86_64/libc/errno.o build-x86_64/libc/fstdio.o build-x86_64/libc/fstdio_unlocked.o build-x86_64/libc/getopt.o build-x86_64/libc/locale.o build-x86_64/libc/malloc.o build-x86_64/libc/serial.o build-x86_64/libc/setjmp.o build-x86_64/libc/signal.o build-x86_64/libc/stdio.o build-x86_64/libc/stdlib.o build-x86_64/libc/string.o build-x86_64/libc/strtod.o build-x86_64/libc/synnixos.o build-x86_64/libc/syscall.o build-x86_64/libc/syscalls.o build-x86_64/libc/time.o build-x86_64/libc/todo.o build-x86_64/libc/unistd.o build-x86_64/libc/vector.o build-x86_64/libc/x86_64/synnixos.o build-x86_64/libsocs.a  build-x86_64/libm.a build-x86_64/libm/math.o build-x86_64/libelf.a build-x86_64/libelf/elf-snx.o build-x86_64/libc.so build-x86_64/libc_so/crt0.o build-x86_64/libc_so/crti.o build-x86_64/libc_so/crtn.o build-x86_64/libc_so/ctype.o build-x86_64/libc_so/entry.o build-x86_64/libc_so/errno.o build-x86_64/libc_so/fstdio.o build-x86_64/libc_so/fstdio_unlocked.o build-x86_64/libc_so/getopt.o build-x86_64/libc_so/locale.o build-x86_64/libc_so/malloc.o build-x86_64/libc_so/serial.o build-x86_64/libc_so/setjmp.o build-x86_64/libc_so/signal.o build-x86_64/libc_so/stdio.o build-x86_64/libc_so/stdlib.o build-x86_64/libc_so/string.o build-x86_64/libc_so/strtod.o build-x86_64/libc_so/synnixos.o build-x86_64/libc_so/syscall.o build-x86_64/libc_so/syscalls.o build-x86_64/libc_so/time.o build-x86_64/libc_so/todo.o build-x86_64/libc_so/unistd.o build-x86_64/libc_so/vector.o build-x86_64/libc_so/x86_64/synnixos.o build-x86_64/libk.a build-x86_64/libk/ctype.o build-x86_64/libk/errno.o build-x86_64/libk/malloc.o build-x86_64/libk/setjmp.o build-x86_64/libk/signal.o build-x86_64/libk/stdio.o build-x86_64/libk/stdlib.o build-x86_64/libk/string.o build-x86_64/libk/x86_64/synnixos.o build-x86_64/snxk.elf build-x86_64/fs/char_devices.o build-x86_64/fs/directory.o build-x86_64/fs/fs.o build-x86_64/fs/membuf.o build-x86_64/fs/pipe.o build-x86_64/fs/procfs.o build-x86_64/fs/socket.o build-x86_64/kernel/debug.o build-x86_64/kernel/dmgr.o build-x86_64/kernel/elf.o build-x86_64/kernel/exec.o build-x86_64/kernel/irq.o build-x86_64/kernel/main.o build-x86_64/kernel/mman.o build-x86_64/kernel/mod.o build-x86_64/kernel/multiboot.o build-x86_64/kernel/pci.o build-x86_64/kernel/pmm.o build-x86_64/kernel/rand.o build-x86_64/kernel/ringbuf.o build-x86_64/kernel/serial.o build-x86_64/kernel/signal.o build-x86_64/kernel/spalloc.o build-x86_64/kernel/string.o build-x86_64/kernel/sync.o build-x86_64/kernel/sync_testbed.o build-x86_64/kernel/syscall.o build-x86_64/kernel/tarfs.o build-x86_64/kernel/tests.o build-x86_64/kernel/thread.o build-x86_64/kernel/timer.o build-x86_64/kernel/trace.o build-x86_64/kernel/tty.o build-x86_64/kernel/ubsan.o build-x86_64/kernel/uname.o build-x86_64/linker/elf-snx.o build-x86_64/linker/modld.o build-x86_64/x86/acpi.o build-x86_64/x86/apic.o build-x86_64/x86/boot.o build-x86_64/x86/cpu.o build-x86_64/x86/halt.o build-x86_64/x86/interrupt.o build-x86_64/x86/isrs.o build-x86_64/x86/pic.o build-x86_64/x86/pit.o build-x86_64/x86/uart.o build-x86_64/x86/vmm.o build-x86_64/crt0.o build-x86_64/crt/crt0.o build-x86_64/sh build-x86_64/sh-/eval.o build-x86_64/sh-/parse.o build-x86_64/sh-/readline.o build-x86_64/sh-/sh.o build-x86_64/sh-/token.o build-x86_64/ld-snx.so build-x86_64/ld-snx/syscall.o build-x86_64/ld-snx/syscalls.o build-x86_64/ld-snx/elf-snx.o build-x86_64/ld-snx/ldso.o build-x86_64/ld-snx/pltstub.o build-x86_64/syscall.ko build-x86_64/modules/syscall.o build-x86_64/procmod.ko build-x86_64/modules/procmod.o build-x86_64/tagha build-x86_64/user/tagha.o build-x86_64/brainfuck build-x86_64/user/brainfuck.o build-x86_64/ls build-x86_64/user/ls.o build-x86_64/column build-x86_64/user/column.o build-x86_64/trace build-x86_64/user/trace.o build-x86_64/modsys build-x86_64/user/modsys.o build-x86_64/cd build-x86_64/user/cd.o build-x86_64/step build-x86_64/user/step.o build-x86_64/false build-x86_64/user/false.o build-x86_64/shutdown build-x86_64/user/shutdown.o build-x86_64/testmath build-x86_64/user/testmath.o build-x86_64/modprobe build-x86_64/user/modprobe.o build-x86_64/mmap build-x86_64/user/mmap.o build-x86_64/clear build-x86_64/user/clear.o build-x86_64/rm build-x86_64/user/rm.o build-x86_64/cat build-x86_64/user/cat.o build-x86_64/init build-x86_64/user/init.o build-x86_64/testserial build-x86_64/user/testserial.o build-x86_64/kill build-x86_64/user/kill.o build-x86_64/chmod build-x86_64/user/chmod.o build-x86_64/time build-x86_64/user/time.o build-x86_64/strace build-x86_64/user/strace.o build-x86_64/sleep build-x86_64/user/sleep.o build-x86_64/date build-x86_64/user/date.o build-x86_64/echo build-x86_64/user/echo.o build-x86_64/whoami build-x86_64/user/whoami.o build-x86_64/top build-x86_64/user/top.o build-x86_64/rot13 build-x86_64/user/rot13.o build-x86_64/xd build-x86_64/user/xd.o build-x86_64/create build-x86_64/user/create.o build-x86_64/args build-x86_64/user/args.o build-x86_64/uname build-x86_64/user/uname.o build-x86_64/true build-x86_64/user/true.o build-x86_64/getenv build-x86_64/user/getenv.o build-x86_64/pwd build-x86_64/user/pwd.o build-x86_64/traceback build-x86_64/user/traceback.o
