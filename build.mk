...
build-x86_64/init: build-x86_64/init-/init.o sysroot/usr/lib/libc.a sysroot/usr/lib/crt0.o
	$(call MP_INFO,LD	init)
	@~/.local/bin/x86_64-synnixos-gcc -g -static -o build-x86_64/init build-x86_64/init-/init.o 
build-x86_64/init-/init.o: init/init.c
	@mkdir -p build-x86_64/init-
	@mkdir -p dep/init-
	$(call MP_INFO,CC	init.o)
	@~/.local/bin/x86_64-synnixos-gcc -std=c11 -Wall -Wextra -Werror -g -O2 -Wno-unused-variable -Wno-unused-parameter -Wno-unused-function -Wno-sign-compare -Wno-address-of-packed-member $(CFLAGS) -Wno-builtin-declaration-mismatch -Wno-format $(USER_CFLAGS) -static -MD -MF dep/init-/init.d -c init/init.c -o build-x86_64/init-/init.o
...
sysroot/init: build-x86_64/init
	$(call MP_INFO,install	init)
	@cp build-x86_64/init sysroot/init
