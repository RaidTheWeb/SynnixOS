...
def generated(f)
  f.puts "// AUTO GENERATED FILE, EDITING IS WORTHLESS :)"
  f.puts
end
...
header_guard("kernel/include/snx/autogenerated_syscall_consts.h") do |f|
  f.puts "enum snx_syscall {"
  f.puts "    SNX_INVALID,"
...
header_guard("kernel/include/snx/autogenerated_syscalls.h") do |f|
